namespace Zebra.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        ID_Music = c.Int(nullable: false),
                        Content = c.String(),
                        CommentModelsVM_ID = c.Int(),
                    })
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.CommentModelsVMs", t => t.CommentModelsVM_ID)
                .Index(t => t.CommentModelsVM_ID);
            
            CreateTable(
                "dbo.CommentModelsVMs",
                c => new
                    {
                        ID = c.Int(nullable: false, identity: true),
                        Comment_ID = c.Int(),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.CommentModels", "CommentModelsVM_ID", "dbo.CommentModelsVMs");
            DropForeignKey("dbo.CommentModelsVMs", "Comment_ID", "dbo.CommentModels");
            ...
            DropIndex("dbo.CommentModelsVMs", new[] { "Comment_ID" });
            DropIndex("dbo.CommentModels", new[] { "CommentModelsVM_ID" });
            ...
            DropTable("dbo.CommentModelsVMs");
